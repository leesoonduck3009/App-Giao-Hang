...
END
GO
CREATE TRIGGER TrUSetOrderPriceOfCustomerOrderDetial ON CustomerOrderDetail FOR INSERT 
AS
BEGIN
...
INSERT INTO Account (UserName,Password,AccountCreateTime) VALUES (N'admin','1234',GETDATE())
INSERT INTO Customer (CustomerName,CustomerRank,DateCreate,Birthday) VALUES(N'Nguyễn Văn B', 'Đồng', GETDATE(),'01/01/1999')
INSERT INTO CustomerOrderInformation (CustomerID,Address,PhoneNumber) VALUES('1','211 Phạm Văn Đồng', '0123123123'),
																		('1','241 HVT', '01112312')
INSERT INTO CustomerOrder(CustomerOrderInformationID,EmployeeID,OrderDate,OrderStatus) VALUES('1','1',GETDATE(),'Đang giao')
INSERT INTO Product(ProductName,Price,Description) VALUES (N'Sản phẩm A', 100000, 'Sản phẩm A có tính năng BC')
INSERT INTO Product(ProductName,Price,Description) VALUES (N'Sản phẩm B', 500000, 'Sản phẩm B có tính năng CD')

INSERT INTO CustomerOrderDetail(CustomerOrderID,ProductID,Quantity) VALUES('1','1',10)
